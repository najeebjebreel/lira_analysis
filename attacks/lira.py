...
from comprehensive_analysis.metrics import compute_roc_metrics, compute_tpr_at_fpr, compute_precision
...
class LiRA:
    ...
    def compute_scores(self):
        ...
        6. Save scores to model_i/scores/scores.npy with shape [N, A]
